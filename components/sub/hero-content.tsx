  ...
  return (
    <main className="w-full min-h-screen flex justify-start items-start relative px-4 md:pl-20 py-12 overflow-hidden bg-white dark:bg-[#05080a] transition-colors duration-700">
      ...
      <motion.div
        ...
        /* Ajuste de tamanho (w-[95vw]) e posição (-right-60) para o novo rosto */
      ...
      >
        <div className="relative w-full h-full">
          <Image
            ...
            fill
            /* Centralizado para focar no olhar do rosto gerado */
            className="object-right object-center object-contain opacity-95"
            style={{
              // Máscara de desintegração para o branco do fundo
          ...
          {/* Camada de Glitch na base (Estética Cyberpunk) */}
